...
const skillsSection = {
  title: "What I do",
  subTitle: "INSIGHT-HUNGRY DATA SCIENTIST WHO LIVES FOR PATTERNS & PREDICTIONS",
  skills: [
    emoji(
      "⚡ Researching, building, and shipping GenAI and ML solutions that work in the real world."
    ),
    emoji("⚡ Deploy models and pipelines using third-party cloud platforms like AWS, GCP"),
    emoji(
